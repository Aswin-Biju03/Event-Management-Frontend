    ...
    <div className="bg-bg text-text min-h-screen px-6 pt-24 pb-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <input type="text" placeholder="Search events by title..." value={search}
                          ...
                          {confirmId === event._id ? (
                            <div className="flex gap-1">
                              <button onClick={() => handleDelete(event._id)}
                                className="text-xs px-2.5 py-1.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-bold">
                                Confirm
                              </button>
